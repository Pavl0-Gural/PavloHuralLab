...
public class ToDoController {
    ...
    public String create(@PathVariable("owner_id") long ownerId, Model model) {
        logger.info("Request: GET /todos/create/users/" + ownerId);
    ...
    public String create(@PathVariable("owner_id") long ownerId, @Validated @ModelAttribute("todo") ToDo todo, BindingResult result) {
        logger.info("Request: POST /todos/create/users/" + ownerId);
        if (result.hasErrors()) {
            return "create-todo";
        }
    ...
    public String read(@PathVariable long id, Model model) {
        logger.info("Request: GET /todos/" + id + "/tasks");
    ...
    public String update(@PathVariable("todo_id") long todoId, @PathVariable("owner_id") long ownerId, Model model) {
        logger.info("Request: GET /todos/" + todoId + "/update/users/" + ownerId);
    ...
    public String update(@PathVariable("todo_id") long todoId, @PathVariable("owner_id") long ownerId,
        ...
        logger.info("Request: POST /todos/" + todoId + "/update/users/" + ownerId);
        if (result.hasErrors()) {
            todo.setOwner(userService.readById(ownerId));
            return "update-todo";
        }
    ...
    public String delete(@PathVariable("todo_id") long todoId, @PathVariable("owner_id") long ownerId) {
        logger.info("Request: GET /todos/" + todoId + "/delete/users/" + ownerId);
    ...
    public String getAll(@PathVariable("user_id") long userId, Model model) {
        logger.info("Request: GET /todos/users/" + userId);
    ...
    public String addCollaborator(@PathVariable long id, @RequestParam("user_id") long userId) {
        logger.info("Request: GET /todos/" + id + "/add");
        ToDo todo = todoService.readById(id);
